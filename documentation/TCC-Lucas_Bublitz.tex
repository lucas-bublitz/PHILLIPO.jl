...
\titulo{PHILLIPO: aplicação do método de elementos finitos na análise estática de estruturas sólidas utilizando alguns ascpetos de programação funcional, processamento paralelo e empacotamento}%
...
\include{Textuais/mecanicaSolidos}
