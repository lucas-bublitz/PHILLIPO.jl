...
\titulo{PHILLIPO: aplicação do método de elementos finitos na análise estática de estruturas sólidas utilizando alguns aspectos de processamento paralelo e empacotamento}%
