...
\titulo{PHILLIPO: aplicação do método de elementos finitos na análise estática de estruturas sólidas utilizando alguns aspectos de programação funcional, processamento paralelo e empacotamento}%
