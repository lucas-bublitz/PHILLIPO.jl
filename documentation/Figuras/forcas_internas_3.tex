 ...
 \newcommand\DrawStretch[2][]{%
  \draw[ultra thin,domain=#2,#1] foreach \Ang in {270,273,...,360}
   ...
   (\u,{R(\u)*cos(\Ang)},{R(\u)*sin(\Ang)})};
     ...
     \draw[->, thick] (4,0.25,-0.25) --++ (0.5,0,0) node[right]{\tiny $\Delta P_x$};
     \draw[->, thick] (3.75,0,-0.25) --++ (0,-0.5,0) node[left]{\tiny $\Delta P_z$};
     \draw[->, thick] (3.75,0.25,0)  --++ (0,0,0.5) node[above]{\tiny $\Delta P_y$};     
