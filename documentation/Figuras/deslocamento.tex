\begin{figure}
    ...
    \begin{tikzpicture}[
        ...
        \draw[marrow]  (0,0) -- (A.center) node[midway,above left]{\large $\bm{a}$};
        \draw[marrow]  (0,0) -- (B.center) node[midway,above left]{\large $\bm{b}$};
        \draw[marrow]  (0,0) -- (A'.center) node[midway,above]{\large $\bm{a}'$};
        \draw[marrow]  (0,0) -- (B'.center) node[midway,below]{\large $\bm{b}'$};

        \draw[marrowb]  (A.center) -- (A'.center) node[midway,below]{$\bm{\varphi}(\bm{A})$};
        \draw[marrowb]  (B.center) -- (B'.center) node[midway,below]{$\bm{\varphi}(\bm{B})$};
